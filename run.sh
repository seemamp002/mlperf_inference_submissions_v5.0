...
INFERENCE_RESULTS_VERSION=v4.1 INFERENCE_RESULTS_REPO_OWNER=${INFERENCE_RESULTS_REPO_OWNER} INFERENCE_RESULTS_REPO_BRANCH=${INFERENCE_RESULTS_REPO_BRANCH} INFERENCE_RESULTS_REPO_NAME=${INFERENCE_RESULTS_REPO_NAME} bash docinit.sh
